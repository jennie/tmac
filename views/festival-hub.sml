      ...
      .container
        .row
          .col-md-3.hidden-sm.sidebar
            span.download-platforms
              a(href='http://twitter.com/TOMediaArts')
          ...
          .col-md-9
            h1 Festival Hub–affordable shared space for Toronto's film and art festivals
            .row
              .col-md-6
                p.lead TMAC is excited to announce a collaborative festival hub to support Toronto’s growing array of film and art festivals.
                p.lead Receive the space and administrative support you need to run your festival so you can focus resources on creative and dynamic programming, curating and exhibitions.
              .col-md-6
            ...
            .row
              .col-md-6
                ...
                ul
                  li 24/7 drop-in access to hot desks with ergonomic chairs, functional workspace, and super-fast wi-fi
                  li Festival and event scheduling tools exclusive to TMAC Festival members
                  li Centralized administration system for festival support
                  li Mailing address, shipping and receiving and print traffic support
                  li Dedicated file and small equipment/supplies storage
                  li Design, printing, and ad buys
