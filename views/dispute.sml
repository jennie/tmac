extends(src='layout.sml')
  ...
  block(name='meta')
    ...
    meta(name='description' content="A comprehensive timeline and documentation of TMAC's 2015 lawsuit against the City of Toronto and Urbancorp over the Section 37 space at 36 Lisgar.")
  ...
  block(name='content')
    ...
    header(style="background-image:url(/images/photos/TMAC-gallery.jpg); background-position: center bottom")
      a(href="/")
          ...
          .row
            .col-lg-3
              ...
              div(class='toc' md).
                ...
                -   [Reply to Urbancorp and City of Toronto Filed](#sod-reply) July 22, 2015
            ...
            .col-lg-6
              ...
              div(md).
                ...
                **February 6, 2018**
                ...
                The following is a [joint statement](https://www.toronto.ca/home/media-room/backgrounders-other-resources/city-tmac-joint-statement/) issued by TMAC and the City of Toronto:
              ...
              div(md).
                ...
                ### Mediation progress &amp; Urbancorp bankruptcy<a name=progress></a>
                ...
                **September 30, 2016**
                ...
                ### Active 18 AGM<a name=mediation></a>

                **June 21, 2016**

                TMAC representatives and members attended the [Active 18 AGM](https://www.facebook.com/342646939086975/photos/a.665435810141418.1073741825.342646939086975/1264474673570859/?type=3&theater) on June 21.
                ...
                **September 21, 2015**
                ...
                ### Reply to Urbancorp and City of Toronto Filed <a name=sod-reply></a>
              ...
              div.alert.alert-success
                span TMAC remains open to talking to the City about how to resolve this situation. We need Councillor Bailao to meet us halfway and take steps to begin a formal, transparent, accountable process to get everyone to a positive resolution. It's not too late for the City to take responsibility for its actions and do right by TMAC, Toronto artists and the West Queen West community.
              ...
              div(md).
                ...
                -   Operating under our [collaborative governance model](https://governance.tomediaarts.org) as a charitable organization. We don't have our permanent home yet, but we'll adapt as we always have to the resources we have and the challenges in front of us.
                ...
                We're very grateful to our lead donors and funders for their continued support! If you're interested in TMAC's future, consider [making a tax-deductible donation](https://www.canadahelps.org/en/charities/toronto-media-arts-centre/). Stay tuned on [Twitter](http://twitter.com/TOMediaArts) and [Facebook](https://www.facebook.com/pages/Toronto-Media-Arts-Centre/842345815814723), [join our mailing list](http://eepurl.com/bq2DVf), and we'll keep in touch!

                ---

                ### Response to the City's Statement of Defense <a name=sod-response></a>

                **June 29, 2015**

                Today, the City of Toronto [responded](http://www.scribd.com/doc/270024689/City-of-Toronto-statement-of-defense-TMAC-lawsuit) to the statement of claim TMAC filed on May 28. It’s an interesting document filled with many assertions and much erroneous information. We are curious to see how the Court responds to the City’s claims.
              ...
              div.alert.alert-success
                span TMAC wholeheartedly stands by our claim. We invite the City to make good on its promises and ensure this community benefit does not fail West Queen West.

              div(md).

                ---

                ### A Way Forward<a name=way-forward></a>
                ...
                **When that was taken away, we felt hopelessly backed into a corner.**
                ...
                We want our building back, yes! We also want West Queen West to have the community-engaged arts space it very much deserves and needs. The one [Active 18](http://www.active18.net/?page_id=1117), the community and all our organizations have worked so hard for.
              ...
              div.alert.alert-success
                span We can fix this together. <b>We want to fix this together.</b> Bring TMAC back to the table. Rebuild the trust and goodwill needed to ensure Toronto can continue to secure the cultural spaces that make our city both vibrant and livable.

              div(md).

                ------------------------------------------------------------------------

                ### Open Letter Re: The Cultural Space at 36 Lisgar <a name=letter></a>
                ...
                **June 15, 2015**
                ...
                #### Interference instead of facilitation <a name=interference-instead-of-facilitation></a>
                ...
                **Instead, the City of Toronto directed Urbancorp to allow the date to pass, apparently because it intended to hand the facility over to real estate developer Artscape in the final hour.** \[Edited June 26 to add: Indeed, Artscape CEO Tim Jones [confirmed in the media](http://www.theglobeandmail.com/news/toronto/toronto-arts-consortium-launches-lawsuit-over-queen-west-facility/article24958832/) that Artscape became involved in our project at the City's request weeks before the outside date of our agreement, and **"recommended 'a reset' to city officials and the developer"** — despite our rejection of Artscape's offer of "assistance"\]
                ...
                It is worth noting that Councillor Bailão sits on the [Artscape board of directors](http://www.torontoartscape.org/about-us/artscape-directors) and Alan Saskin, President of Urbancorp, is the chair of the [Artscape Foundation board of directors](http://www.torontoartscape.org/about-us/artscape-directors).
            ...
            .col-lg-3.aside
              .visible-xs
                ...
                a(href="/press") Read the latest media coverage

                h3 Connect with TMAC 👋
                ...
                ul.social
                  ...
                  li: a(href="http://tomediaarts.us11.list-manage.com/subscribe/post?u=a11a58bffdfcead3161ea4d9d&id=0f5e662ee0") Join Our Mailing List
