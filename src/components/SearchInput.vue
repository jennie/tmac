  ...
  <div class="relative mx-auto w-80">
    ...
    <div class="relative w-80">
      <input
        type="text"
        placeholder="Search"
        class="bg-background-form border border-gray-500 rounded-full px-4 pl-10 py-2 outline-none focus:border-black w-80"
        v-model="query"
        @input="softReset"
        @keyup="performSearch"
    ...
    <transition name="fade">
      ...
      >
        <div class="flex flex-col" ref="results">
          ...
          >
            <div
              class="article-title text-left text-xl font-bold m-0"
              v-html="marked(post.item.title)"
            />
            <div class="summary" v-html="marked(post.item.summary)" />
          </a>
